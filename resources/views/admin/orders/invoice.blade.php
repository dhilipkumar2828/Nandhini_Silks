            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="product-meta">SKU: {{ $item->variant->sku ?? ($item->product->sku ?? 'N/A') }}</div>
            ...
            <div class="words-section">
                ...
                @php
                    if (!function_exists('numberToWords')) {
                        function numberToWords($number) {
                            ...
                            if ($number < 21) {
                                ...
                                if ($remainder) $string .= ' and ' . numberToWords($remainder);
                            } elseif ($number < 100000) {
                                $thousands = (int)($number / 1000);
                                $remainder = $number % 1000;
                                $string = numberToWords($thousands) . ' ' . $dictionary[1000];
                                if ($remainder) $string .= ($remainder < 100 ? ' and ' : ', ') . numberToWords($remainder);
                    ...
                    if (class_exists('NumberFormatter')) {
                        ...
                        $words = numberToWords($order->grand_total);
                    }
                @endphp
