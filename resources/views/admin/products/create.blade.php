                ...
                <div class="card-glass p-6 rounded-2xl shadow-sm bg-white">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="weight" step="0.01" min="0.1" value="{{ old('weight', '0.10') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="is_featured" class="w-full bg-slate-50 border border-slate-200 px-3 py-2 rounded-lg text-sm outline-none focus:border-[#a91b43] transition-all">
                            <option value="1" {{ old('is_featured', '1') == '1' ? 'selected' : '' }}>Yes — Homepage</option>
                    ...
                    <div>
                        ...
                        <select name="is_free_delivery" class="w-full bg-slate-50 border border-slate-200 px-3 py-2 rounded-lg text-sm outline-none focus:border-[#a91b43] transition-all">
                            <option value="1" {{ old('is_free_delivery', '1') == '1' ? 'selected' : '' }}>Yes</option>
                    ...
                    <td class="px-4 py-4">
                        <div class="flex flex-col gap-2 min-w-[150px]">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0.1" name="v_weight[${comboIds}]" value="${ui ? ui.weight : '0.10'}" class="w-full bg-white border border-rose-200 rounded-lg px-3 py-1.5 text-xs font-bold text-rose-700 outline-none focus:border-[#a91b43] transition-all" placeholder="0.10">
