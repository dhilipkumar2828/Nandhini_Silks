        ...
        <form id="subCategoryForm" action="{{ route('admin.sub-categories.update', $subCategory->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1.5">
                    ...
                    <textarea name="description" id="description" class="hidden">{{ old('description', $subCategory->description) }}</textarea>
                </div>
                <div class="space-y-1.5">
                    ...
                    <textarea name="specification" id="specification" class="hidden">{{ old('specification', $subCategory->specification) }}</textarea>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        const descContent = $('#description').val();
        ...
        const specContent = $('#specification').val();
